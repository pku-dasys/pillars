...
trait ElementTrait extends Ports with BasicTrait {
   ...
   *
   * @param fanInNums   a list of the serial numbers of fan-ins
   * @param fanOutNums  a list of the serial numbers of fan-outs
   * @param internalNum the serial numbers of internal node that
   */
